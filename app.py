...
guidelines_page = st.Page("pages/guides/3_guidelines.py", title="Guidelines", icon=":material/assignment_turned_in:")

# current page
pg = st.navigation({
    "Reports": [overview_page, details_page],
    "Tools": [uploads_page, explore_page, documentation_page],
    "Guides": [style_page, features_page, guidelines_page]
})
